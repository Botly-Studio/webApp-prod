...
BotlyStudio.bindActionFunctions = function() {
  ...
  BotlyStudio.bindClick_('setCompilerLocationButton', function () {
    BotlyAgent.setCompilerLocation();
  });
};
...
BotlyStudio.sendCode = function (flag) {
  ...
  BotlyAgent.sendSketchToServer(BotlyStudio.generateArduino(), flag);
};

BotlyStudio.downloadCode = function(){
...
BotlyStudio.setCompilerLocationHtml = function (jsonResponse) {
  var newEl = BotlyAgent.createElementFromJson(jsonResponse);
...
BotlyStudio.setIdeSettings = function (e, preset) {
  ...
  //TODO: check how BotlyAgent deals with invalid data and sanitise here
};
